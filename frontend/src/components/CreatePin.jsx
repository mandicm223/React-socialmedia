...
const CreatePin = ({ user }) => {
  ...
  const uploadImage = (e) => {
    ...
    if(type === 'image/png' || type === 'image/jpeg' || type === 'image/svg') {
                ...
                <div>
                  ...
                  >
                    ...
                    {categories.map((categorie) => (
                      <option value={categorie.name} className='text-base border-0 outline-none capitalize bg-white text-black'>{categorie.name}</option>
                    ))}
                  </select>
                </div>
